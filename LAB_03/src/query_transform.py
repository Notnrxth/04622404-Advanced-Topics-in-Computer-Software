...
#
#     "I twisted my foot"                  ← everyday wording
#     Knowledge base: "sprained ankle"
#
...
SLANG_MAP = {
    "เลือดไหลไม่หยุด": "ห้ามเลือด",
    "น้ำร้อนลวก": "แผลไฟไหม้น้ำร้อนลวก",
    "โดนไฟลวก": "แผลไฟไหม้น้ำร้อนลวก",
    "ตุ่มน้ำ": "ตุ่มพอง",
    "เท้าพลิก": "ข้อเท้าแพลง",
    "กระดูกร้าว": "กระดูกหัก",
    "ตัวร้อน": "มีไข้",
    "ท้องร่วง": "ท้องเสีย",
    "ผงเข้าตา": "สิ่งแปลกปลอมเข้าตา",
    "หมอฉุกเฉิน": "1669",
}
...
def normalize_query(query):
    ...
    ปรับคำถามแบบไม่ใช้ AI — เร็วและฟรี
        ...
        "เท้าพลิกทำไงดีครับ"  →  "ข้อเท้าแพลงทำไงดี"
    """
