...
Answer questions using only the `fruit_q_a.txt` knowledge base (retrieval-based QA).
...
#DISCLAIMER = (
#    "For education only. Season and price may vary by year and region."
#)
...
def main():
    ...
    print("-RAG System for Thai Fruit Guide QA ---")
